// BitmapEx.cpp: implementation of the GST_bitmap class.
//
//////////////////////////////////////////////////////////////////////
...
void GST_bitmap::Create(long width, long height)
{
	// Deinit members
	if (m_lpData != NULL)
	{
...
void GST_bitmap::Create(GST_bitmap& bitmapEx)
{
...
void GST_bitmap::Create(GST_bitmap* pBitmapEx)
{
	// Check for valid bitmap
...
void GST_bitmap::Load(LPTSTR lpszBitmapFile)
{
...
void GST_bitmap::Load(LPBYTE lpBitmapData)
{
...
void GST_bitmap::Load(HBITMAP hBitmap)
{
...
void GST_bitmap::Save(LPTSTR lpszBitmapFile)
{
	// Check for valid .BMP file path
	if (lpszBitmapFile != NULL)
	{
...
void GST_bitmap::Save(LPBYTE lpBitmapData)
{
	// Check for valid bitmap data buffer
	if (lpBitmapData != NULL)
	{
...
void GST_bitmap::Save(HBITMAP& hBitmap)
{
...
float GST_bitmap::_ARG(float xa, float ya)
{
	float _arg = 0.0f;
...
float GST_bitmap::_MOD(float x, float y, float z)
{
	float _mod = 0.0f;
...
void GST_bitmap::_ConvertTo32Bpp()
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ConvertTo24Bpp()
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ScaleNearestNeighbour(long horizontalPercent, long verticalPercent)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ScaleBilinear(long horizontalPercent, long verticalPercent)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ScaleBicubic(long horizontalPercent, long verticalPercent)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Scale(long horizontalPercent, long verticalPercent)
{
...
void GST_bitmap::_ScaleNearestNeighbour2(long width, long height)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ScaleBilinear2(long width, long height)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ScaleBicubic2(long width, long height)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Scale2(long width, long height)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::_RotateNearestNeighbour(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_RotateBilinear(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_RotateBicubic(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Rotate(long degrees, _PIXEL bgColor)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::Crop(long x, long y, long width, long height)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Shear(long degreesX, long degreesY, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ShearVerticalNearestNeighbour(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ShearVerticalBilinear(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ShearVerticalBicubic(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ShearVertical(long degrees, _PIXEL bgColor)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::_ShearHorizontalNearestNeighbour(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ShearHorizontalBilinear(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ShearHorizontalBicubic(long degrees, _PIXEL bgColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::_ShearHorizontal(long degrees, _PIXEL bgColor)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::FlipHorizontal()
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Clear(_PIXEL clearColor)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Sepia(long depth)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Pixelize(long size)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Brightness(long brightness)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Contrast(long contrast)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Rank(bool bMinimum)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Spread(long distanceX, long distanceY)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Offset(long offsetX, long offsetY)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::BlackAndWhite(long offset)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::GlowingEdges(long blur, long threshold, long scale)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::EqualizeHistogram(long levels)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Posterize(long levels)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Solarize(long threshold)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Draw(HDC hDC, long dstX, long dstY)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::Draw(long dstX, long dstY, long width, long height, GST_bitmap& bitmapEx, long srcX, long srcY)
{
	// Check for valid bitmap
...
void GST_bitmap::Draw(long dstX, long dstY, long width, long height, GST_bitmap& bitmapEx, long srcX, long srcY, long alpha)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::Draw(_QUAD dstQuad, GST_bitmap& bitmapEx)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::Draw(_QUAD dstQuad, GST_bitmap& bitmapEx, long alpha)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::Draw(_QUAD dstQuad, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::Draw(_QUAD dstQuad, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawNearestNeighbour(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawBilinear(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawBicubic(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::Draw(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::_DrawNearestNeighbour(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawBilinear(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawBicubic(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::Draw(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::DrawTransparent(long dstX, long dstY, long width, long height, GST_bitmap& bitmapEx, long srcX, long srcY, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawTransparent(_QUAD dstQuad, GST_bitmap& bitmapEx, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawTransparent(long dstX, long dstY, long width, long height, GST_bitmap& bitmapEx, long srcX, long srcY, long alpha, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawTransparent(_QUAD dstQuad, GST_bitmap& bitmapEx, long alpha, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawTransparentNearestNeighbour(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawTransparentBilinear(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawTransparentBicubic(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawTransparent(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, _PIXEL transparentColor)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::DrawTransparent(_QUAD dstQuad, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawTransparentNearestNeighbour(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawTransparentBilinear(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawTransparentBicubic(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawTransparent(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha, _PIXEL transparentColor)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::DrawTransparent(_QUAD dstQuad, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long alpha, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawBlended(long dstX, long dstY, long width, long height, GST_bitmap& bitmapEx, long srcX, long srcY, long startAlpha, long endAlpha, DWORD mode)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawBlendedNearestNeighbour(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long startAlpha, long endAlpha, DWORD mode)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawBlendedBilinear(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long startAlpha, long endAlpha, DWORD mode)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawBlendedBicubic(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long startAlpha, long endAlpha, DWORD mode)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawBlended(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, long startAlpha, long endAlpha, DWORD mode)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::DrawMasked(long dstX, long dstY, long width, long height, GST_bitmap& bitmapEx, long srcX, long srcY, _PIXEL transparentColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawAlpha(long dstX, long dstY, long width, long height, GST_bitmap& bitmapEx, long srcX, long srcY, long alpha, _PIXEL alphaColor)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawCombined(long dstX, long dstY, long width, long height, GST_bitmap& bitmapEx, long srcX, long srcY, DWORD mode)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawCombinedNearestNeighbour(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, DWORD mode)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawCombinedBilinear(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, DWORD mode)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::_DrawCombinedBicubic(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, DWORD mode)
{
	// Check for valid bitmap
	if (IsValid() && bitmapEx.IsValid())
	{
...
void GST_bitmap::DrawCombined(long dstX, long dstY, long dstWidth, long dstHeight, GST_bitmap& bitmapEx, long srcX, long srcY, long srcWidth, long srcHeight, DWORD mode)
{
	// Check for resampling mode
	switch (m_ResampleMode)
	{
...
void GST_bitmap::DrawTextA(long dstX, long dstY, LPSTR lpszText, _PIXEL textColor, long textAlpha, LPTSTR lpszFontName, long fontSize, BOOL bBold, BOOL bItalic)
{
	// Check for valid bitmap
...
void GST_bitmap::DrawTextW(long dstX, long dstY, LPWSTR lpszText, _PIXEL textColor, long textAlpha, LPTSTR lpszFontName, long fontSize, BOOL bBold, BOOL bItalic)
{
	// Check for valid bitmap
	if (IsValid() && (lpszText != NULL))
	{
...
_PIXEL GST_bitmap::GetPixel(long x, long y)
{
...
_PIXEL GST_bitmap::_RGB2HSV(_PIXEL rgbPixel)
{
	_PIXEL hsvPixel = 0;
...
_PIXEL GST_bitmap::_HSV2RGB(_PIXEL hsvPixel)
{
	_PIXEL rgbPixel = 0;
...
void GST_bitmap::CreateFireEffect()
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::UpdateFireEffect(BOOL bLarge, long iteration, long height)
{
	// Check for valid bitmap
...
void GST_bitmap::CreateWaterEffect()
{
	// Check for valid bitmap
	if (IsValid())
	{
		...
		if (m_pWaterBitmap != NULL)
			delete m_pWaterBitmap;
		m_pWaterBitmap = new GST_bitmap();
		m_pWaterBitmap->Create(this);
	}
}

void GST_bitmap::UpdateWaterEffect(long iteration)
{
	// Check for valid bitmap
...
void GST_bitmap::MakeWaterBlob(long x, long y, long size, long height)
{
	// Check for valid bitmap
	if (IsValid() && (m_lpWaterHeightField1 != NULL) && (m_lpWaterHeightField2 != NULL))
	{
...
void GST_bitmap::CreateSmokeEffect()
{
	// Check for valid bitmap
	if (IsValid())
	{
...
void GST_bitmap::UpdateSmokeEffect(long offsetX, long offsetY, long offsetZ)
{
	// Check for valid bitmap
	if (IsValid())
	{
...
_SIZE GST_bitmap::MeasureTextA(LPSTR lpszText, LPTSTR lpszFontName, long fontSize, BOOL bBold, BOOL bItalic)
{
	_SIZE szText = {0, 0};
...
_SIZE GST_bitmap::MeasureTextW(LPWSTR lpszText, LPTSTR lpszFontName, long fontSize, BOOL bBold, BOOL bItalic)
{
	_SIZE szText = {0, 0};
...
void GST_bitmap::GetRedChannel(LPBYTE lpBuffer)
{
	// Check for valid bitmap
...
void GST_bitmap::GetGreenChannel(LPBYTE lpBuffer)
{
	// Check for valid bitmap
	if (IsValid() && (lpBuffer != NULL))
	{
...
void GST_bitmap::GetBlueChannel(LPBYTE lpBuffer)
{
	// Check for valid bitmap
	if (IsValid() && (lpBuffer != NULL))
	{
...
void GST_bitmap::GetRedChannelHistogram(long lpBuffer[256], BOOL bPercent)
{
	// Check for valid bitmap
	if (IsValid() && (lpBuffer != NULL))
	{
...
void GST_bitmap::GetGreenChannelHistogram(long lpBuffer[256], BOOL bPercent)
{
	// Check for valid bitmap
	if (IsValid() && (lpBuffer != NULL))
	{
...
void GST_bitmap::GetBlueChannelHistogram(long lpBuffer[256], BOOL bPercent)
{
	// Check for valid bitmap
	if (IsValid() && (lpBuffer != NULL))
	{
