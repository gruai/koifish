...
#include "Manifold/DataLoader.hpp"
...
int main() {
    ...
    GPT2 model;
    gpt2_build_from_checkpoint(&model, "./src/llmc/gpt2_124M.bin");

    // build the DataLoaders from tokens files. for now use tiny_shakespeare if available, else tiny_stories
    const char* tiny_stories_train = "./src/llmc//tinystories/TinyStories_train.bin";
    const char* tiny_stories_val = "./src/llmc//tinystories/TinyStories_val.bin";
    const char* tiny_shakespeare_train = "./src/llmc//tinyshakespeare/tiny_shakespeare_train.bin";
    const char* tiny_shakespeare_val = "./src/llmc/tinyshakespeare/tiny_shakespeare_val.bin";
    ...
    printf("train dataset(%ld)\tnum_batches: %zu\n", train_loader.num_tokens,(int)(train_loader.num_tokens / (B*T)));
    printf("val dataset(%ld)\tnum_batches: %zu\n", val_loader.num_tokens,(int)(val_loader.num_tokens / (B*T)));
    int val_num_batches = 5;

    // build the Tokenizer
    Tokenizer tokenizer;
    tokenizer_init(&tokenizer, "./src/llmc/gpt2_tokenizer.bin");
