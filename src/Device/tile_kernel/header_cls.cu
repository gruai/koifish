...
extern "C" __global__ void __launch_bounds__(128, 1) header_cls_V151936_T64_64_S49152_bfloat16(bfloat16_t* __restrict__ grad_pre_logits, const int* __restrict__ labels, float* __restrict__ losses, bfloat16_t* __restrict__ pre_logits, int N, int nValidToken) {
...
extern "C" __global__ void __launch_bounds__(128, 1) header_cls_V66_T64_64_S49152_bfloat16(bfloat16_t* __restrict__ grad_pre_logits, const int* __restrict__ labels, float* __restrict__ losses, bfloat16_t* __restrict__ pre_logits, int N, int nValidToken) {
  extern __shared__ __align__(1024) uchar buf_dyn_shmem[];
  void* workspace = ((void*)((char*)buf_dyn_shmem + 0));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 512));
  float lse[1];
  ...
  if (condval == 0) {
    ...
    if ((((int)threadIdx.x) < 66)) {
      condval_1 = pre_logits[((((int64_t)((int)blockIdx.x)) * (int64_t)66) + ((int64_t)((int)threadIdx.x)))];
    } else {
      condval_1 = bfloat16_t(0x0p+0f/*0.000000e+00*/);
    }
    z[0] = condval_1;
    ...
    if ((((int)threadIdx.x) < 66)) {
      condval_2 = pre_logits[((((int64_t)((int)blockIdx.x)) * (int64_t)66) + ((int64_t)((int)threadIdx.x)))];
    } else {
    ...
    z[0] = ((bfloat16_t)(exp2f(((((float)z[0]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/) - lse[0])) / ((float)nValidToken)));
    if (((int)threadIdx.x) < 66) {
      grad_pre_logits[((((int64_t)((int)blockIdx.x)) * (int64_t)66) + ((int64_t)((int)threadIdx.x)))] = z[0];
    }
    __syncthreads();
    bfloat16_t condval_3;
    if (((0 <= label) && (label < 66))) {
      condval_3 = grad_pre_logits[((((int64_t)((int)blockIdx.x)) * (int64_t)66) + ((int64_t)label))];
    } else {
    ...
    if (0 <= label) {
      if (label < 66) {
        grad_pre_logits[((((int64_t)((int)blockIdx.x)) * (int64_t)66) + ((int64_t)label))] = ((bfloat16_t)((max(((float)p_label), 0x1.79ca10c924223p-67f/*1.000000e-20*/) - 0x1p+0f/*1.000000e+00*/) / ((float)nValidToken)));
      }
    }
  } else {
    if (((int)threadIdx.x) < 66) {
      row[0] = bfloat16_t(0x0p+0f/*0.000000e+00*/);
      pre_logits[((((int64_t)((int)blockIdx.x)) * (int64_t)66) + ((int64_t)((int)threadIdx.x)))] = row[0];
    }
    losses[((int64_t)((int)blockIdx.x))] = 0x0p+0f/*0.000000e+00*/;
  }
}
